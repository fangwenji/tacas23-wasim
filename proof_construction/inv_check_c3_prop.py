...
def ila_trans():
    ...
    sts, _ = btor_parser.parse_file(Path("/data/wenjifang/WASIM/design/testcase4-four_stage_pipe2/problem_add.btor2"))
...
def main(extracted_list, sv_extracted_list):
    ...
    # unsat_expr_list_n = []
    # for a in unsat_expr_list:
    #     a_n = Not(a)
    #     unsat_expr_list_n.append(a_n)
    # asmpt_unsat_n = And(unsat_expr_list_n)
    # asmpt_l0 = Or(inv_group0.asmpt_group)
    # check = And(asmpt_l0, asmpt_unsat_n)
    # check_result = is_sat(check)
    # print(check_result)
